...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<VwSiparisRaporu> VwSiparisRaporus { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)

#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-H6KLH85\\SQLEXPRESS;Initial Catalog=Northwind;Integrated Security=True;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Category>(entity =>
        {
            ...
            entity.Property(e => e.CategoryId).HasColumnName("CategoryID"); //PROPERT VAR İSMİ CAYEGORYID, İSMİDE cATEGORYID
            entity.Property(e => e.CategoryName).HasMaxLength(15);
        ...
        modelBuilder.Entity<VwSiparisRaporu>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_SiparisRaporu");
